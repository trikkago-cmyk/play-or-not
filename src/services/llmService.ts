...
function getSystemInstruction({
  ...
  if (mode === 'recommendation') {
    ...
    19. 禁止使用伪文艺、产品黑话或英文直译表达，例如“决策有后劲”“越玩越有账/帐”“决策很有味道”“舒服区间”“甜点区”“sweet spot”“不掉线”“开爽”“后面回来找你算账”。请换成用户能一眼懂的说法：每步都有取舍、三个人正合适、十几分钟就能开起来、长线规划更过瘾。
      ...
      - 禁止使用这些别扭说法：**决策有后劲**、**越玩越有账/帐**、**决策很有味道**、**舒服区间**、**甜点区**、**sweet spot**、**不掉线**、**开爽**、**回来找你算账**。
